...
enum Constants {
    ...
    enum ErrorMessages {
        ...
        static let permissionPromptMessage = "DockAway needs accessibility permission to control the dock. Please grant permission in System Preferences > Privacy & Security > Accessibility."
    }
} 